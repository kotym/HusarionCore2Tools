...
if (USES_SDK OR "${BOARD_TYPE}" STREQUAL robocore)
  set(ADDITIONAL_LINK_DIRS "-L\"${HFRAMEWORK_DIR}/libs/${PORT}_${BOARD_TYPE}_${BOARD_VERSION}\"")
else()
  string(REPLACE _ . BOARD_VERSION_DOT ${BOARD_VERSION})
  set(ADDITIONAL_LINK_DIRS "-L\"${HFRAMEWORK_DIR}/build/${PORT}_${BOARD_TYPE}_${BOARD_VERSION_DOT}\"")
endif()
