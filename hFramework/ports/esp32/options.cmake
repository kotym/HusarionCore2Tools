...
# Allow setting ESP32_SERIAL_PORT via CMake cache.
if(NOT DEFINED ESP32_SERIAL_PORT)
  if(WIN32)
    set(ESP32_SERIAL_PORT "COM3" CACHE STRING "ESP32 serial port for flashing")
  elseif(APPLE)
    set(ESP32_SERIAL_PORT "/dev/tty.usbserial-1420" CACHE STRING "ESP32 serial port for flashing")
  else()
    set(ESP32_SERIAL_PORT "/dev/ttyUSB0" CACHE STRING "ESP32 serial port for flashing")
  endif()
endif()
message(STATUS "ESP32 flash port configured: ${ESP32_SERIAL_PORT}")
