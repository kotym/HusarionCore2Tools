...
extern "C" {
	...
	void analogWrite(int pinIndex, int value)
	{
		...
		{
		case 7:
			hServo.servo1.setPeriod(1000);
			hServo.servo1.setWidth((value + 1) / 255 * 1000);
			break;
		case 8:
			hServo.servo2.setPeriod(1000);
			hServo.servo2.setWidth((value + 1) / 255 * 1000);
			break;
		case 9:
			hServo.servo3.setPeriod(1000);
			hServo.servo3.setWidth((value + 1) / 255 * 1000);
			break;
		case 10:
			hServo.servo4.setPeriod(1000);
			hServo.servo4.setWidth((value + 1) / 255 * 1000);
			break;
		case 11:
			hServo.servo5.setPeriod(1000);
			hServo.servo5.setWidth((value + 1) / 255 * 1000);
			break;
		case 12:
			hServo.servo6.setPeriod(1000);
			hServo.servo6.setWidth((value + 1) / 255 * 1000);
			break;
		default:
