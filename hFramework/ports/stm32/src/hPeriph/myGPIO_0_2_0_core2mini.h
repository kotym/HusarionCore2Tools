...
DEFINE_PORT____(MYGPIO_MOT2A_IN             ,  26, C, 15, -1)
DEFINE_PORT____(MYGPIO_MOT2B_IN             ,  27, C, 14, -1)
...
DEFINE_PORT____(MYGPIO_MOT1A_IN             ,  31, A,  4, -1)
DEFINE_PORT____(MYGPIO_MOT1B_IN             ,  32, A,  5, -1)
